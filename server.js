...
api.use('/api', expressJwt({ secret: process.env.secret || config.secret }).unless({ path: ['/api/usuario/authenticate', '/api/usuario/register','/api/jogador/registra','/api/sala/register','/api/jogo1', '/api/sala/valida','/api/sala/createJogador', '/api/sala/pontuacao', '/api/usuario/loginTeste', '/api/sala/testeSala' ] }));
